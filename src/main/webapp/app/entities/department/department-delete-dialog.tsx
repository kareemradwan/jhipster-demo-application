...
export const DepartmentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jHipsterDemoApp.department.delete.question">
        <Translate contentKey="jHipsterDemoApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
