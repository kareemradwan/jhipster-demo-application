  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jHipsterDemoApp.employee.home.createOrEditLabel" data-cy="EmployeeCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jHipsterDemoApp.employee.firstName')}
              ...
              <ValidatedField
                label={translate('jHipsterDemoApp.employee.lastName')}
              ...
              />
              <ValidatedField
                label={translate('jHipsterDemoApp.employee.email')}
                id="employee-email"
                name="email"
                data-cy="email"
                type="text"
              />
              <ValidatedField
                label={translate('jHipsterDemoApp.employee.phoneNumber')}
              ...
              />
              <ValidatedField
                label={translate('jHipsterDemoApp.employee.hireDate')}
              ...
              />
              <ValidatedField
                label={translate('jHipsterDemoApp.employee.salary')}
                id="employee-salary"
                name="salary"
                data-cy="salary"
                type="text"
              />
              <ValidatedField
                label={translate('jHipsterDemoApp.employee.commissionPct')}
              ...
              <ValidatedField
                ...
                name="manager"
                data-cy="manager"
                label={translate('jHipsterDemoApp.employee.manager')}
                type="select"
              >
                <option value="" key="0" />
                {employees
              ...
              <ValidatedField
                ...
                name="department"
                data-cy="department"
                label={translate('jHipsterDemoApp.employee.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments
