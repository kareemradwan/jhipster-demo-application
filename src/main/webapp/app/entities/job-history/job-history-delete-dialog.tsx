...
export const JobHistoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jHipsterDemoApp.jobHistory.delete.question">
        <Translate contentKey="jHipsterDemoApp.jobHistory.delete.question" interpolate={{ id: jobHistoryEntity.id }}>
